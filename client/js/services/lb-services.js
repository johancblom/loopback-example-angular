      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/Todos/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Todo.category() instead.
            "prototype$__get__category": {
              url: urlBase + "/Todos/:id/category",
              method: "GET",
            },
            ...
            // INTERNAL. Use Category.todos.findById() instead.
            "::findById::Category::todos": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/Categories/:id/todos/:fk",
              method: "GET",
            },

            // INTERNAL. Use Category.todos.destroyById() instead.
            "::destroyById::Category::todos": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/Categories/:id/todos/:fk",
            ...
            // INTERNAL. Use Category.todos.updateById() instead.
            "::updateById::Category::todos": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/Categories/:id/todos/:fk",
            ...
            // INTERNAL. Use Category.todos() instead.
            "::get::Category::todos": {
              isArray: true,
              url: urlBase + "/Categories/:id/todos",
              method: "GET",
            },

            // INTERNAL. Use Category.todos.create() instead.
            "::create::Category::todos": {
              url: urlBase + "/Categories/:id/todos",
              method: "POST",
            },

            // INTERNAL. Use Category.todos.createMany() instead.
            "::createMany::Category::todos": {
              isArray: true,
              url: urlBase + "/Categories/:id/todos",
              method: "POST",
            },

            // INTERNAL. Use Category.todos.destroyAll() instead.
            "::delete::Category::todos": {
              url: urlBase + "/Categories/:id/todos",
              method: "DELETE",
            },

            // INTERNAL. Use Category.todos.count() instead.
            "::count::Category::todos": {
              url: urlBase + "/Categories/:id/todos/count",
              method: "GET",
            },
          }
        );
        ...
        R["removeById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Todo#updateAttributes
             * @methodOf lbServices.Todo
             *
             * @description
             *
        ...
        */
        ...
        R.category = function() {
          ...
          var action = TargetResource["::get::Todo::category"];
 ...
 */
  module.factory(
    ...
    /**
     * @ngdoc object
     * @name lbServices.Category.todos
     * @header lbServices.Category.todos
     * @object
     * @description
     *
     * The object `Category.todos` groups methods
     * manipulating `Todo` instances related to `Category`.
     *
     * Call {@link lbServices.Category#todos Category.todos()}
     ...
     */
        ...
        R.todos = function() {
          ...
          var action = TargetResource["::get::Category::todos"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Category.todos#count
             * @methodOf lbServices.Category.todos
             *
             * @description
             *
             * Counts todos of Category.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - Category id
        ...
        R.todos.count = function() {
          var TargetResource = $injector.get("Todo");
          var action = TargetResource["::count::Category::todos"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Category.todos#create
             * @methodOf lbServices.Category.todos
             *
             * @description
             *
        ...
        R.todos.create = function() {
          var TargetResource = $injector.get("Todo");
          var action = TargetResource["::create::Category::todos"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Category.todos#createMany
             * @methodOf lbServices.Category.todos
             *
             * @description
             *
        ...
        R.todos.createMany = function() {
          var TargetResource = $injector.get("Todo");
          var action = TargetResource["::createMany::Category::todos"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Category.todos#destroyAll
             * @methodOf lbServices.Category.todos
             *
             * @description
             *
        ...
        R.todos.destroyAll = function() {
          var TargetResource = $injector.get("Todo");
          var action = TargetResource["::delete::Category::todos"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Category.todos#destroyById
             * @methodOf lbServices.Category.todos
             *
             * @description
             *
        ...
        R.todos.destroyById = function() {
          var TargetResource = $injector.get("Todo");
          var action = TargetResource["::destroyById::Category::todos"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Category.todos#findById
             * @methodOf lbServices.Category.todos
             *
             * @description
             *
        ...
        R.todos.findById = function() {
          var TargetResource = $injector.get("Todo");
          var action = TargetResource["::findById::Category::todos"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Category.todos#updateById
             * @methodOf lbServices.Category.todos
             *
             * @description
             *
        ...
        R.todos.updateById = function() {
          var TargetResource = $injector.get("Todo");
          var action = TargetResource["::updateById::Category::todos"];
          return action.apply(R, arguments);
        };
